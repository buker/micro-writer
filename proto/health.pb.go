...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=microwriter.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_proto_health_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x77, 0x72, 0x69, 0x74, 0x65,
	...
	0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x6d, 0x69, 0x63, 0x72,
	0x6f, 0x77, 0x72, 0x69, 0x74, 0x65, 0x72, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68,
	...
	,
...
var file_proto_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: microwriter.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: microwriter.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: microwriter.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: microwriter.HealthCheckResponse.status:type_name -> microwriter.HealthCheckResponse.ServingStatus
	1, // 1: microwriter.Health.Check:input_type -> microwriter.HealthCheckRequest
	1, // 2: microwriter.Health.Watch:input_type -> microwriter.HealthCheckRequest
	2, // 3: microwriter.Health.Check:output_type -> microwriter.HealthCheckResponse
	2, // 4: microwriter.Health.Watch:output_type -> microwriter.HealthCheckResponse
